...
public class adventure {
    ...
    public static int kingsCall(){
        ...
        keys.nextLine();
        System.out.println("King: 'You need to find the Legendary Sword of Flame, hidden in the volcano up north.' \n      'The Water Shield, hidden in the deep lake to the east.' \n      'And the Rock Armor, hidden in the desert to the west.' [ENTER]");
        keys.nextLine();
        System.out.println("King: 'The Dragon's Lair is to the south, you'll have to go there after collecting all the legendary warrior pieces.' \n      'I wish you luck brave warrior, please save our kingdom!' [ENTER]");
        keys.nextLine();
        System.out.println("After the King's yap sesh, you leave the castle in search for the  legendary warrior pieces. [ENTER]");
        keys.nextLine();
        splitpaths();
        return 0;
    }
    ...
    public static int desertStart(){
        ...
        keys.nextLine();
        System.out.println("Do you plan to go towards the temple? or keep searching around your area. [1] Go towards the temple, or [2] Ignore it. ");
    ...
    public static int desertcont1()
    {
        ...
        keys.nextLine();
        System.out.println("It seems that you need to break the ground as it will unvail more treasures, do you break the block? [1] Break the block to the side, or [2] Break the middle block. ");
        ...
        if (choiceD2 == 1){
            ...
            keys.nextLine();
            System.out.println("You look down and see a TRAP! pressure plate waiting to be stepped on the ground. With your big smart brain, you broke the block to the side and didn't land on the pressure plate. [ENTER]");
            desertcont2();
        }
        if (choiceD2 == 2){
            System.out.println("You decided to break the ground knowing the risk for breaking your legs as you land. [ENTER]"); 
    ...
    public static int desertcont2()
    {
        ...
        if (choiceD3 == 2){
            ...
            keys.nextLine();
            System.out.println("Ending 8: [get pernked asshat lol by: Dyllan Mouly]"); //ENDING
        }
        if (choiceD3 == 3){
        ...
        if (choiceD3 == 4){
            ...
            keys.nextLine();
            System.out.println("You grabbed the armor and climbed out of the hole, and out towards the crossroads to contine your adventure.");
            splitpaths();
        }
        return 0;
